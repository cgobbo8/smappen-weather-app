...
<template>
  <div class="relative">
    <input
      ...
      class="shadow bg-gray-800/40 backdrop-blur-xl appearance-none border border-gray-700 rounded w-80 py-2 px-3 text-gray-200 leading-tight focus:outline-none focus:border-blue-600 focus:shadow-outline"
      type="text"
      v-model="inputValue"
    />
    <div
    ...
    >
      <ul class="overflow-y-auto h-full">
        <li
          ...
          v-for="(city, i) in cityStore.loadedCities"
          :key="city.name + i"
